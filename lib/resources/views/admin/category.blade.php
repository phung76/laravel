						...
						<div class="panel-body">
							<form action="" method="post">
								<div class="form-group">
									...
									<input required type="text" name="name" class="form-control" placeholder="Tên danh mục..."><br>
								</div>
								<div class="form-group">
									<input type="submit" name="submit" value="thêm sản phẩm" class="btn btn-primary btn-sm">
								</div>
								{{ csrf_field() }} 
							</form>
