...
<title>@yield('title') | phamngocphung</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{asset('admin/home')}}">Pham Ngoc Phung</a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<li><a href="{{asset('logout')}}"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> {{Auth::user()->email}}</a></li>
						</ul>
					</li>
				</ul>
			</div>
